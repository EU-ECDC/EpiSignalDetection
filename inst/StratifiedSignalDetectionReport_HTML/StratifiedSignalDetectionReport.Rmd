...
country(ies) reporting at least 1 case in the alarm detection period.
* There are `r sum(datasetTP$NumValue, na.rm=TRUE)` cases reported 
in the alarm detection period, all strata added up.
...
```{r AlarmTableByGeo, results = 'hide'}
...
```{r AlarmTableByPop, results = 'hide'}
